    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="rounded-lg border border-red-300 bg-red-50 p-5">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-md bg-red-100 ring-1 ring-red-300">
            <FileWarning className="h-5 w-5 text-red-700" />
          </div>
          <div className="flex-1">
            <div className="text-sm font-semibold text-red-800">Rejected claim</div>
            <dl className="mt-3 grid grid-cols-1 gap-x-8 gap-y-2 sm:grid-cols-2 text-sm">
              <Row label="Claim ref" value={<span className="font-mono text-sky-700">{rejectedClaim.ref}</span>} />
              ...
              <div className="sm:col-span-2">
                ...
                <dd className="mt-0.5 text-sm text-red-800">{rejectedClaim.reason}</dd>
              </div>
            </dl>
          </div>
        </div>
      ...
      {(stage === "typing" || stage === "done") && (
        <div className="rounded-lg border border-amber-200 bg-slate-50 p-6">
          ...
          <pre
            className={[
              "whitespace-pre-wrap font-sans text-sm leading-relaxed text-slate-900",
      ...
      {stage === "done" && (
        <div className="fade-in-up flex flex-wrap gap-3">
          ...
          <button
            ...
            className="rounded-md border border-slate-200 px-4 py-2.5 text-sm font-medium text-slate-800 hover:bg-slate-100"
          >
